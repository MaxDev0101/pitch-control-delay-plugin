...
tresult PLUGIN_API PitchControlDelayProcessor::setupProcessing (Vst::ProcessSetup& newSetup)
{
    ...
    circularBuffer.resizeBufferOnSampleRateChange(sampleRate); // always sampleRate*2 buffer size
...
//------------------------------------------------------------------------
void PitchControlDelayProcessor::updateDelaySamplesFromParameter(Vst::ParamValue normalizedValue) {
